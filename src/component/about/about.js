    ...
    <>
      ...
      <div className={style.main_container}>
        <div className={style.formabout_container}>
          ...
          <i>
            As a MERN (MongoDB, Express.js, React.js, Node.js) developer, you're
            skilled in building full-stack web applications using some of the
            most popular and powerful technologies in the industry.
            <b>if you like my projects and skills pls <br/>contact me through form.</b>
          </i>
        </div>
