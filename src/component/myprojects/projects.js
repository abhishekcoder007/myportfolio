        ...
        <div className={style.rightside}>
          ...
          <div className={style.projectcontent}>
            <p className={style.tehstack}>
              <b className={style.tehstackhead}>Tech-Stack:-</b><span> Html Css Css-Animation React, Recoil,
              React Router DOM, and npm package like multi--carousel </span>
            </p>
            <p className={style.techlink}><b className={style.techdetails}>Link:--</b><a href="https://menzhub.netlify.app/"style={{textDecoration:"none",fontFamily:"cursive",fontSize:"2rem",color:"blue"}} download>Menz-Hub</a></p>

            <p><b className={style.techdetails}>Details:-</b>
      ...
      <div className={style.main2}>
        <div className={style.rightside}>
          ...
          <div className={style.projectcontent}>
            <p className={style.tehstack}>
              <b className={style.tehstackhead}>Tech-Stack:-</b><span> Html Css Css-Animation React, Recoil,
              React Router DOM, and npm package like email.js for contact-us</span>
            </p>
            <p><b className={style.tehstackhead}>Link:--</b><a href="https://myportfolio-rust-nine.vercel.app/" style={{textDecoration:"none",fontFamily:"cursive",fontSize:"2rem", color:"blue"}}>My-Portfolio</a></p>
            <p><b className={style.techdetails}>Details:-</b>
              <i>
